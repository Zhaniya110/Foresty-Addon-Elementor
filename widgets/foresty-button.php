...
class Elementor_Foresty_Button extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'button_style',
            [
                'label' => __('Foresty Button Style','foresty-addon-elementor'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'full-button',
                'options' => [
                    'full-button'=> __('Full Button','foresty-addon-elementor'),
                    'opague-button' => __('Opague Button','foresty-addon-elementor')
                ]
            ]
        );
	...
	protected function render() {
        ...
        echo '<a href="' . esc_url($settings['button_link']['url']) . '" ' . $nofollow . ' class="foresty-btn ' . $settings['button_style'] . '">' . esc_html($settings['button_text']) . '</a>';
        echo '</div>';
	}
}